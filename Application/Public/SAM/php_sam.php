...
function sam_e($s) {global $eol;echo '-->'.$s."$eol";}
function sam_t($s) {global $eol;echo '   '.$s."$eol";}
...
//  var $debug = true;
  ...
  function Create($proto) {
      if ($this->debug) sam_e("SAMConnection.Create(proto=$proto)");
      $rc = false;
  ...
  function SAMConnection() {
    if ($this->debug) sam_e('SAMConnection()');
  ...
  /* ---------------------------------
     ...
     --------------------------------- */
  function Commit() {
    if ($this->debug) sam_e('SAMConnection.Commit()');
    $rc = true;
  ...
  function Connect($proto='', $options=array()) {
    if ($this->debug) sam_e('SAMConnection.Connect()');
    $rc = false;
  ...
  /* ---------------------------------
     ...
     --------------------------------- */
  function Disconnect() {
    if ($this->debug) sam_e('SAMConnection.Disconnect()');
    $rc = true;
  ...
  function IsConnected() {
    if ($this->debug) sam_e('SAMConnection.IsConnected()');
    $rc = true;
  ...
  function Peek($target, $options=array()) {
    if ($this->debug) sam_e('SAMConnection.Peek()');
    $rc = true;
  ...
  function PeekAll($target, $options=array()) {
    if ($this->debug) sam_e('SAMConnection.PeekAll()');
    $rc = true;
  ...
  function Receive($target, $options=array()) {
    if ($this->debug) sam_e('SAMConnection.Receive()');
    $rc = true;
  ...
  function Remove($target, $options=array()) {
    if ($this->debug) sam_e('SAMConnection.Remove()');
    $rc = true;
  ...
  /* ---------------------------------
     ...
     --------------------------------- */
  function Rollback() {
    if ($this->debug) sam_e('SAMConnection.Rollback()');
    $rc = true;
  ...
  function Send($target, $msg, $options=array()) {
    if ($this->debug) sam_e('SAMConnection.Send()');
    $rc = true;
  ...
  function SetDebug($option=false) {
    if ($this->debug) sam_e("SAMConnection.SetDebug($option)");
  ...
  function Subscribe($topic, $options=array()) {
    if ($this->debug) sam_e("SAMConnection.Subscribe($topic)");
    $rc = true;
  ...
  function Unsubscribe($sub_id) {
    if ($this->debug) sam_e("SAMConnection.Unsubscribe($sub_id)");
    $rc = true;
